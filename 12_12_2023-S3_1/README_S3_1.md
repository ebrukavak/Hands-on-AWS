...
```text
Bucket name                 : myfirstbucket-aslan-01(instead of "aslan", students use their  own clarusway student number)
Region                      : N.Virginia
...
- Upload `cat2.jpg` and `cat3.jpg` files under `myfirstbucket-aslan-01` bucket.
